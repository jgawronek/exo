...
<div
  class="filter-popover absolute right-0 top-full mt-2 w-64 bg-xeo-dark-gray border border-xeo-green/10 rounded-lg shadow-xl z-20"
        ...
        {#each availableCapabilities as cap}
          ...
          <button
            ...
            class="px-2 py-1 text-xs font-mono rounded transition-colors {isSelected
              ? 'bg-xeo-green/20 text-xeo-green border border-xeo-green/30'
